...
namespace ExpFinance
{
    ...
    public partial class AF_GROUPE_FACTURE
    {
        public AF_GROUPE_FACTURE()
        {
            this.AF_FACTURE = new HashSet<AF_FACTURE>();
        }
        ...
        public virtual ICollection<AF_FACTURE> AF_FACTURE { get; set; }
    }
}
